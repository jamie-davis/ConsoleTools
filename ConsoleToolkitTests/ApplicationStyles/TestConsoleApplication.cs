...
namespace ConsoleToolkitTests.ApplicationStyles
{
    ...
    public class TestConsoleApplication
    {
        ...
        {
            Toolkit.ParsingConventions = CommandLineParserConventions.MsDosConventions;
            UnitTestAppUtils.Run<HelpApp>(new[] { "/h" }, _console);
        ...
        {
            Toolkit.ParsingConventions = CommandLineParserConventions.MsDosConventions;
            UnitTestAppUtils.Run<InvalidHelpApp>(new[] { "/h" }, _console);
        }

        [Test]
        public void SelfHandledCommandIsExecuted()
        {
            UnitTestAppUtils.Run<SelfHandledCommandApp>(new string[] {}, _console);
            Approvals.Verify(_console.GetBuffer());
        }
        ...
        {
            UnitTestAppUtils.Run<HandlerClassApp>(new string[] {}, _console);
            Approvals.Verify(_console.GetBuffer());
        }
