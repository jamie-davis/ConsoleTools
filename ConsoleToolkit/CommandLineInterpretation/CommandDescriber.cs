    ...
    public static class CommandDescriber
    {
        ...
        private static void AddCommandListText(IConsoleAdapter console, CommandLineInterpreterConfiguration config, IOptionNameHelpAdorner adorner)
        {
            ...
            if (commands.Any())
            {
                ...
                console.WriteLine();
                console.FormatTable(commands.Select(c => new {Command = c.Name, Text = FormatCommandDescription(c, adorner: adorner)}), ReportFormattingOptions.OmitHeadings);
            }
        }
        ...
        private static IConsoleRenderer FormatCommandDescription(BaseCommandConfig command, string prefixText = null, IOptionNameHelpAdorner adorner = null)
        {
            ...
            if (positionalsPresent)
            {
                ...
                formatter.FormatTable(positionals, ReportFormattingOptions.OmitHeadings);
            }
            ...
            if (optionsPresent)
            {
                ...
                formatter.FormatTable(options, ReportFormattingOptions.OmitHeadings);
            }
